...
public class QuietHours extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
            ...
            mQuietHoursActiveDisplay.setChecked(Settings.System.getInt(resolver, Settings.System.QUIET_HOURS_ACTIVE_DISPLAY, 0) == 1);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mQuietHoursEnabled) {
            ...
            Settings.System.putInt(resolver, Settings.System.QUIET_HOURS_ACTIVE_DISPLAY,
