...
public class QuietHours extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
            ...
            mCallBypassNumber.setSummary(mCallBypassNumber.getEntries()[callBypassNumber] + " "
                    + R.string.quiet_hours_calls_required_summary);
            ...
            final String code = mPrefs.getString(KEY_AUTO_SMS_MESSAGE, defaultCode);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mQuietHoursTimeRange) {
            ...
            int val = Integer.parseInt((String) newValue);
            mCallBypassNumber.setSummary(mCallBypassNumber.getEntries()[val] + " "
                    + R.string.quiet_hours_calls_required_summary);
            return true;
        }
        return false;
