    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
            ...
            if (telephonyManager.getPhoneType() == TelephonyManager.PHONE_TYPE_NONE) {
                ...
                String ringtoneString = mPrefs.getString(KEY_BYPASS_RINGTONE, null);
                if (ringtoneString == null) {
                    // Value not set, defaults to Default Alarm Tone
                    ...
                    if (ringtoneAlarm != null) {
                        ...
                        // Default alarm tone is silent
                        mBypassRingtone.setSummary(R.string.quiet_hours_bypass_ringtone_null);
                    }
                } else {
