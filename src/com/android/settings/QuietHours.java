...
public class QuietHours extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_QUIET_HOURS_ACTIVE_DISPLAY ="quiet_hours_active_display";
    ...
    private CheckBoxPreference mQuietHoursActDsp;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
            ...
            mQuietHoursActDsp = (CheckBoxPreference) findPreference(KEY_QUIET_HOURS_ACTIVE_DISPLAY);
            ...
            mQuietHoursActDsp.setChecked(Settings.System.getInt(resolver, Settings.System.ACTIVE_DISPLAY_RESPECT_QH, 0) == 1);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mQuietHoursEnabled) {
            ...
            return true;
        } else if (preference == mQuietHoursActDsp) {
            Settings.System.putInt(resolver, Settings.System.ACTIVE_DISPLAY_RESPECT_QH,
                    mQuietHoursActDsp.isChecked() ? 1 : 0);
            return true;
