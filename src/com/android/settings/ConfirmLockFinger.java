    ...
    private class VerifyRunner implements Runnable {
        public void run() {
            ...
            try {
                ...
                int iResult = mLockPatternUtils.fingerprintUnlock("lap-verify", ConfirmLockFinger.this);
                if (AM_STATUS.getDeclaredField("eAM_STATUS_OK").getInt(AM_STATUS) == iResult) {
                    Log.i(TAG, "LAP Verify OK");
                    setResult(RESULT_OK);
                    finish();

                } else if (AM_STATUS.getDeclaredField("eAM_STATUS_NO_STORED_CREDENTIAL").getInt(AM_STATUS) == iResult) {
                ...
                } else if (AM_STATUS.getDeclaredField("eAM_STATUS_LIBRARY_NOT_AVAILABLE").getInt(AM_STATUS) == iResult) {
                ...
                } else if (AM_STATUS.getDeclaredField("eAM_STATUS_UI_TIMEOUT").getInt(AM_STATUS) == iResult) {
                ...
                } else if (AM_STATUS.getDeclaredField("eAM_STATUS_CREDENTIAL_LOCKED").getInt(AM_STATUS) == iResult) {
