...
public class MessagingHelper {
    ...
    public static final String START_SERVICE_COMMAND =
            "com.android.settings.service.START_SERVICE_COMMAND";
    ...
    public static int returnUserCallBypassCount(Context context) {
        ...
        return Integer.parseInt(prefs.getString(
                KEY_REQUIRED_CALLS, String.valueOf(DEFAULT_DISABLED)));
    }
    ...
    public static void scheduleService(Context context) {
        ...
        PendingIntent startIntent = makeServiceIntent(context, START_SERVICE_COMMAND, 1);
        PendingIntent stopIntent = makeServiceIntent(context, STOP_SERVICE_COMMAND, 2);
