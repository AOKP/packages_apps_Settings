...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (MessagingHelper.START_SERVICE_COMMAND.equals(action)) {
            context.startService(new Intent(context, SmsCallService.class));
        } else if (SCHEDULE_SERVICE_COMMAND.equals(action)) {
            MessagingHelper.scheduleService(context);
        } else {
            context.stopService(new Intent(context, SmsCallService.class));
            MessagingHelper.scheduleService(context);
        }
    }
