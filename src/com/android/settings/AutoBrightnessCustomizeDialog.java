...
public class AutoBrightnessCustomizeDialog extends AlertDialog
    ...
    private void updateSettings(boolean forceDefault) {
        ...
        if (!forceDefault) {
            lux = fetchItems(Settings.AOKP.AUTO_BRIGHTNESS_LUX);
            values = fetchItems(Settings.AOKP.AUTO_BRIGHTNESS_BACKLIGHT);
        }
    ...
    private void putSettings() {
        ...
        putItems(Settings.AOKP.AUTO_BRIGHTNESS_LUX, lux);
        putItems(Settings.AOKP.AUTO_BRIGHTNESS_BACKLIGHT, values);
    }

    private int[] fetchItems(String setting) {
        String value = Settings.AOKP.getString(getContext().getContentResolver(), setting);
        if (value != null) {
    ...
    private void putItems(String setting, int[] values) {
        ...
        Settings.AOKP.putString(getContext().getContentResolver(), setting, value);
    }
