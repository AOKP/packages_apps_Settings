...
public class Utilities {
    ...
    public static String getModVersion() {
        String full = SystemProperties.get("ro.aokp.version");
        if (full != null) {
            String[] splitted = full.split("_");
            String aokp_ver = splitted[splitted.length-1];
            Pattern pattern = Pattern.compile("^(build|milestone)-[0-9]+$");
