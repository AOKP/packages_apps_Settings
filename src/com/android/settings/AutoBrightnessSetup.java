...
public class AutoBrightnessSetup extends AlertActivity implements
    ...
    protected void onStart() {
        ...
        float currentSensitivity = Settings.AOKP.getFloat(resolver,
        ...
        mTwilightAdjustment.setChecked(Settings.AOKP.getInt(resolver,
                Settings.AOKP.AUTO_BRIGHTNESS_TWILIGHT_ADJUSTMENT, 0) != 0);
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (selection >= 0) {
            ...
            Settings.AOKP.putFloat(resolver,
                    Settings.AOKP.AUTO_BRIGHTNESS_RESPONSIVENESS, sensitivity);
        }
        ...
        Settings.AOKP.putInt(resolver,
                Settings.AOKP.AUTO_BRIGHTNESS_TWILIGHT_ADJUSTMENT,
