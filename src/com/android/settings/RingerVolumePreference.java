...
public class RingerVolumePreference extends VolumePreference {
    ...
    protected void onBindDialogView(View view) {
        ...
        if (Utils.isVoiceCapable(getContext())) {
            ...
            if (Settings.AOKP.getInt(getContext().getContentResolver(),
            ...
            linkCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                        ...
                        Settings.AOKP.putInt(buttonView.getContext().getContentResolver(),
                                Settings.AOKP.VOLUME_LINK_NOTIFICATION, 1);
                    } else {
                        notificationSection.setVisibility(View.VISIBLE);
                        ringerDesc.setText(R.string.volume_ring_only_description);
                        linkMuteStates.setEnabled(true);
                        Settings.AOKP.putInt(buttonView.getContext().getContentResolver(),
                                Settings.AOKP.VOLUME_LINK_NOTIFICATION, 0);
                    }
                    updateSlidersAndMutedStates();
                }
            });
            ...
            if (Settings.AOKP.getInt(getContext().getContentResolver(),
                    Settings.AOKP.VOLUME_KEYS_CONTROL_RING_STREAM, 1) == 1) {
            ...
            volumeKeysControlRingStream.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    Settings.AOKP.putInt(buttonView.getContext().getContentResolver(),
                            Settings.AOKP.VOLUME_KEYS_CONTROL_RING_STREAM, isChecked ? 1 : 0);
                }
