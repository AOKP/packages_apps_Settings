...
public class PreferenceFragment extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        mBlacklistNotify.setChecked(Settings.AOKP.getBoolean(getContentResolver(),
                Settings.AOKP.PHONE_BLACKLIST_NOTIFY_ENABLED, false));
        ...
        mBlacklistRegex.setChecked(Settings.AOKP.getBoolean(getContentResolver(),
                Settings.AOKP.PHONE_BLACKLIST_REGEX_ENABLED, false));
    ...
    public void onResume() {
        ...
        updateSelectListFromPolicy(mBlacklistPrivate,
                Settings.AOKP.PHONE_BLACKLIST_PRIVATE_NUMBER_MODE);
        ...
        updateSelectListFromPolicy(mBlacklistUnknown,
                Settings.AOKP.PHONE_BLACKLIST_UNKNOWN_NUMBER_MODE);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mBlacklistNotify) {
            Settings.AOKP.putBoolean(getContentResolver(),
                    Settings.AOKP.PHONE_BLACKLIST_NOTIFY_ENABLED, (Boolean) objValue);
            ...
            Settings.AOKP.putBoolean(getContentResolver(),
                    Settings.AOKP.PHONE_BLACKLIST_REGEX_ENABLED, (Boolean) objValue);
        }
